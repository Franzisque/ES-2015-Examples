...
var generatorFunction = regeneratorRuntime.mark( /**
...
/**
 * generator implemented with function expression
 */
//let g = function *() {};

/**
 * generator, which is created in an object
 * @type {number}
 */
//let obj = {
//    *g() {}
...
/**
 * computed generator names inside a class
 * @type {string}
 */
//const generatorName = 'g';
//class Animal {
...
function generatorFunction() {
  return regeneratorRuntime.wrap(function generatorFunction$(context$1$0) {
...
// generetor is an iterable? so it can be converted to array?
let values = Array.from(generator);
assert.deepEqual(values, ['hello', 'world']);

// value is hello and done is false
let thisStep = generator.next();
let [value, done] = [thisStep.value, thisStep.done];

// value is world and done is false
generator.next();
let thisStep = generator.next();
let [value, done] = [thisStep.value, thisStep.done];

// done is true after passing last value
generator.next();
generator.next();
let done = generator.next().done;

// get "yield"-values from iterator
...
Q.async(regeneratorRuntime.mark(function callee$0$0() {
    var chatUser, firstUserId, message;
    return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            case 0:
                context$1$0.next = 2;
                return $.get("assets/chat-users.json");

            case 2:
                chatUser = context$1$0.sent;
                firstUserId = chatUser.users[0].id;
                context$1$0.next = 6;
                return $.get("assets/chat-messages.json");
